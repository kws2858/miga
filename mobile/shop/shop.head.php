...
<header id="hd">
    ...
    <ul id="hd_mb">
        ...
        <!-- <li><a href="<?php echo G5_BBS_URL ?>/register.php" id="snb_join">회원가ㅇ</a></li> -->
        <?php } ?>
        <!-- <li><a href="<?php echo G5_SHOP_URL; ?>/mypage.php">마이페이지</a></li> -->
    </ul>

    <div id="hd_wr">
        <div id="logo"><a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_DATA_URL; ?>/common/mobile_logo_img.jpg" alt="<?php echo $config['cf_title']; ?>"></a></div>
        <div id="hd_btn">
