...
$menu['menu400'] = array (
    array('400000', '사이트관리', G5_ADMIN_URL.'/shop_admin/', 'shop_config'),
    array('400100', '사이트설정', G5_ADMIN_URL.'/shop_admin/configform.php', 'scf_config'),
    ...
    array('400300', '렌탈상품관리', G5_ADMIN_URL.'/shop_admin/itemlist.php', 'scf_item'),
    array('400660', '렌탈상품문의', G5_ADMIN_URL.'/shop_admin/itemqalist.php', 'scf_item_qna'),
