...
<header id="hd">
    ...
    <div class="hd_wr">
        <div id="logo"><a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_URL; ?>/img/logo.jpg" alt="<?php echo $config['cf_title']; ?>"></a></div>
        <div id="logo_res"><a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_URL; ?>/img/m_logo.jpg" alt="<?php echo $config['cf_title']; ?>"></a></div>                
