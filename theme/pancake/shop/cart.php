...
<div id="sod_bsk" class="od_prd_list">
    ...
    <div class="tbl_head03 tbl_wrap sod_left">
        <table>
        <thead>
        <tr>
            <th scope="col">
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            if($it_options) {
                $mod_options = '<div class="sod_option_btn"><button type="button" class="mod_options btn_b03">선택사항수정</button></div>';
    ...
    <div class="sod_right">
        ...
        <div id="sod_bsk_act">
            ...
            <a href="<?php echo G5_SHOP_URL; ?>/list.php?ca_id=<?php echo $continue_ca_id; ?>" class="btn_b01">쇼핑 계속하기</a>
